...
const NotFoundPage = () => {
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-teal-100 via-cyan-50 to-blue-50 text-gray-800 overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center text-center p-8">
        ...
        <motion.p
          className="text-lg md:text-xl text-gray-700 max-w-xl mx-auto mb-8 px-4"
